      ...
      <div>
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Co-Hosts Jeremy and Molly dated in High School, joined the military
            and ultimately met again at their 10 year High School Reunion. We
            raised a blended family and dealt with the trials and tribulations
            that come with parenthood. We found fitness and it has made an
            extreme impact on our mentality. Join us on our Transformation
            Journey as we shed our old habits, way of thinking, and old
            perspective as we intend to expand and gain new perspective.
          </div>
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Our goal is to have you, the listener, learn from our experiences to
            know you are not alone and there can be something greater out there
            if you want it and will do what's necessary to get it. Power comes
            from the heart, mind and body. Each one of these harness their own
            strength. Aligning the heart, mind and body as one singular force
            will create a higher level of POWER. BE POWERFUL
          </div>
